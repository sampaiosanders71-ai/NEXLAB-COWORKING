...
const __nexlabCompatibilityDetail=Object.freeze({group:"beta-0-26-11",sourceVersion:"0.26.11",targetVersion:"0.26.19",assetPath:"assets/nexlab-export-vendor-beta-0-26-11.js",mode:'lightweight-bridge',usedAt:new Date().toISOString()});
...
export * from './nexlab-export-vendor-beta-0-26-12.js?v=app-beta-0-26-19-global-error-feedback-assist';
