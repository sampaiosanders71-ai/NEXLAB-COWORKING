(function(){
  ...
  const FEEDBACK_ASSIST_CONTEXT_KEY = 'nexlab:feedback-assist:context:v0.26.29';
  ...
  /* Beta 0.26.29 — clareza visual, formulários e ajuda contextual detalhada */
