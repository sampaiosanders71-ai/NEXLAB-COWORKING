(function(){
  ...
  function run(){
    scheduled = false;
    // Estável: o observador visual não altera atributos, classes ou nós que pertencem
    // à árvore React. Ele mantém apenas o marcador da página para telemetria.
    markPage();
  }
