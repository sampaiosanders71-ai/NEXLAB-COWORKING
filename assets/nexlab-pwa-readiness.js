(function(){
  'use strict';
  const BUILD_IDENTITY=window.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.33',release:'Beta',revision:'beta-0-26-33-mobile-month-calendar',assetRevision:'app-beta-0-26-33-mobile-month-calendar',cacheName:'nexlab-beta-0-26-33-mobile-month-calendar'});
  ...
  const HOMOLOGATION_REVISION=BUILD_IDENTITY.homologationRevision||'beta-0-26-33-mobile-month-calendar';
