(function(){
  'use strict';
  const BUILD_IDENTITY=window.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.22',release:'Beta',revision:'beta-0-26-22-ui-clarity',assetRevision:'app-beta-0-26-22-ui-clarity',cacheName:'nexlab-beta-0-26-22-ui-clarity'});
  ...
  const HOMOLOGATION_REVISION=BUILD_IDENTITY.homologationRevision||'beta-0-26-22-feedback-resolved-bulk-delete';
