(function(){
  ...
  const APP_VERSION = '26.30.34';
  const APP_RELEASE = 'R55.6.22';
  const APP_REVISION = 'decorative-summary-cards-r55622';
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.34';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.34';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.34', JSON.stringify(performanceState));
    } catch {}
