(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.29',release:'Beta',revision:'beta-0-26-29-shell-observers-security-integrity',assetRevision:'app-beta-0-26-29-shell-observers-security-integrity',cacheName:'nexlab-beta-0-26-29-shell-observers-security-integrity',generatedAt:'2026-07-29T02:35:00Z'});
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v0.26.29';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v0.26.29';
  ...
  const USER_ERROR_CONTEXT_KEY = 'nexlab:feedback-assist:context:v0.26.29';
  const USER_ERROR_STATE_KEY = 'nexlab:user-error-state:v0.26.29';
  ...
  const PERFORMANCE_ALERT_STATE_KEY = 'nexlab:performance-alert-state:v0.26.29';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v0.26.29', JSON.stringify(performanceState));
    } catch {}
