(function(){
  ...
  const APP_VERSION = '26.30.25';
  const APP_RELEASE = 'R55.6.12';
  const APP_REVISION = 'gray-background-restored-r55612';
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.25';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.25';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.25', JSON.stringify(performanceState));
    } catch {}
