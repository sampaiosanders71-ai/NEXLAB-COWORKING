(function(){
  ...
  const APP_VERSION = '26.30.23';
  const APP_RELEASE = 'R55.6.10';
  const APP_REVISION = 'global-background-fff2e2-r55610';
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.23';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.23';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.23', JSON.stringify(performanceState));
    } catch {}
