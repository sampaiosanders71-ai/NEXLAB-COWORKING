(function(){
  ...
  const APP_VERSION = '26.30.42';
  const APP_RELEASE = 'R55.6.30';
  const APP_REVISION = 'meeting-response-automation-r55630';
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.42';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.42';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.42', JSON.stringify(performanceState));
    } catch {}
