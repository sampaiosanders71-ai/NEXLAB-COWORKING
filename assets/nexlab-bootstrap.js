(function(){
  ...
  const APP_VERSION = '26.30.26';
  const APP_RELEASE = 'R55.6.13';
  const APP_REVISION = 'inventory-unified-r55613';
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.26';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.26';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.26', JSON.stringify(performanceState));
    } catch {}
