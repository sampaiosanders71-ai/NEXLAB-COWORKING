(function(){
  ...
  const APP_VERSION = '26.30.21';
  const APP_RELEASE = 'R55.6.8';
  const APP_REVISION = 'agenda-privacy-bookings-r5568';
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.21';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.21';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.21', JSON.stringify(performanceState));
    } catch {}
