(function(){
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.31.5';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.31.5';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.31.5', JSON.stringify(performanceState));
    } catch {}
