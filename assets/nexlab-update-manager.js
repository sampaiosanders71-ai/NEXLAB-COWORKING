(function(){
  'use strict';
  if (window.__NEXLAB_UPDATE_MANAGER__?.version === '26.31.16') return;

  const CURRENT_VERSION = '26.31.16';
  const CURRENT_REVISION = 'rc11-bookings-cache-space-participants-tests-r56016';
