/* NEXLAB Beta 0.26.30 — navegação Push com confirmação explícita, deduplicação e fallback seguro. */
(()=>{
  if(globalThis.__NEXLAB_PUSH_NAVIGATION__?.version==='0.26.30')return;
  ...
  const HOMOLOGATION_REVISION=BUILD.homologationRevision||'beta-0-26-30-activity-toolbar-compact';
