const APP_VERSION='26.31.16';
const APP_REVISION='rc11-bookings-cache-space-participants-tests-r56016';
const CACHE_NAME='nexlab-v26-31-16-rc11-cache-space-participants-tests-r56016';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r263116-rc11-cache-space-participants-tests-r56016',
  './assets/index-R56v263116rc11.js?v=app-r263116-rc11-cache-space-participants-tests-r56016',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r263116-rc11-cache-space-participants-tests-r56016',
  './assets/nexlab-runtime-stability-r56016rc11.js?v=app-r263116-rc11-cache-space-participants-tests-r56016',
  './assets/nexlab-update-manager.js?v=app-r263116-rc11-cache-space-participants-tests-r56016',
  './assets/nexlab-realtime-hub-r56016rc11.js?v=app-r263116-rc11-cache-space-participants-tests-r56016',
  './assets/nexlab-visual.css?v=app-r263116-rc11-cache-space-participants-tests-r56016',
  './assets/nexlab-visual.js?v=app-r263116-rc11-cache-space-participants-tests-r56016',
  './assets/nexlab-vapid-rotation.js?v=app-r263116-rc11-cache-space-participants-tests-r56016',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R56v263116rc11.js?v=app-r263116-rc11-cache-space-participants-tests-r56016',self.registration.scope).href,
...
self.addEventListener('install',(event)=>{
  event.waitUntil((async()=>{await precacheShell();await self.skipWaiting();})());
});
