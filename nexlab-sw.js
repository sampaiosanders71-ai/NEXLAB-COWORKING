const APP_VERSION="26.29.3";
const APP_REVISION="mural-dashboard-realtime-r543";
const CACHE_NAME="nexlab-v26-29-3-shell-r543";
const RUNTIME_CACHE="nexlab-v26-29-3-runtime-r543";
const IMAGE_CACHE="nexlab-v26-29-3-images-r543";
const ASSET_VERSION="app-r26293-mural-sync-r543";
const SHELL_FILES=[
  "./","./index.html","./offline.html","./404.html","./homologacao.html",
  "./RELATORIO_NEXLAB_V26_29_3.html","./prontidao.html","./release.json",
  `./manifest.webmanifest?v=${ASSET_VERSION}`,
  `./assets/index-R54v26293.js?v=${ASSET_VERSION}`,
  ...
  `./assets/nexlab-permissions-phase2.css?v=${ASSET_VERSION}`,
  `./assets/nexlab-permissions-phase2.js?v=${ASSET_VERSION}`,
  ...
  `./assets/nexlab-mural-sync-r543.css?v=${ASSET_VERSION}`,
  `./assets/nexlab-mural-sync-r543.js?v=${ASSET_VERSION}`,
...
function injectOverlays(html){
  ...
  if(!value.includes('nexlab-permissions-phase2.js')){
    const permission=`<link rel="stylesheet" href="./assets/nexlab-permissions-phase2.css?v=${ASSET_VERSION}"><script defer src="./assets/nexlab-permissions-phase2.js?v=${ASSET_VERSION}"></script>`;
  ...
  if(!value.includes('nexlab-mural-sync-r543.js')){
    const mural=`<link rel="stylesheet" href="./assets/nexlab-mural-sync-r543.css?v=${ASSET_VERSION}"><script defer src="./assets/nexlab-mural-sync-r543.js?v=${ASSET_VERSION}"></script>`;
