const APP_VERSION="26.30.5";
const APP_REVISION="module-collision-hotfix-r5541";
const CACHE_NAME="nexlab-v26-30-5-shell-r5541";
const RUNTIME_CACHE="nexlab-v26-30-5-runtime-r5541";
const IMAGE_CACHE="nexlab-v26-30-5-images-r5541";
const ASSET_VERSION="app-r26305-module-collision-hotfix-r5541";
const SHELL_FILES=[
  "./","./index.html","./offline.html","./404.html","./homologacao.html",
  "./RELATORIO_NEXLAB_V26_30_5.html","./prontidao.html","./release.json",
