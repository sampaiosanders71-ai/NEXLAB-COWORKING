const APP_VERSION='26.31.5';
const APP_REVISION='stable-bookings-hotfix-r5605';
const CACHE_NAME='nexlab-v26-31-5-bookings-hotfix-r5605';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26315-bookings-hotfix-r5605',
  './assets/index-R56v26315hotfix.js?v=app-r26315-bookings-hotfix-r5605',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26315-bookings-hotfix-r5605',
  './assets/nexlab-runtime-stability-r5605hotfix.js?v=app-r26315-bookings-hotfix-r5605',
  './assets/nexlab-update-manager.js?v=app-r26315-bookings-hotfix-r5605',
  './assets/nexlab-realtime-hub-r5605hotfix.js?v=app-r26315-bookings-hotfix-r5605',
  './assets/nexlab-visual.css?v=app-r26315-bookings-hotfix-r5605',
  './assets/nexlab-visual.js?v=app-r26315-bookings-hotfix-r5605',
  './assets/nexlab-vapid-rotation.js?v=app-r26315-bookings-hotfix-r5605',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R56v26315hotfix.js?v=app-r26315-bookings-hotfix-r5605',self.registration.scope).href,
