const CACHE_NAME = "nexlab-v26-7-5-shell-r2";
const RUNTIME_CACHE = "nexlab-v26-7-5-runtime-r2";
const IMAGE_CACHE = "nexlab-v26-7-5-images-r2";
...
const SHELL_FILES = [
  ...
  "./assets/index-CKPsxFpP.js?v=app-r2675-sidebar1",
  "./assets/index-B1u8eynw.css?v=brand-r38",
  "./assets/nexlab-bootstrap-v26-7.js?v=app-r2675-sidebar1",
  "./assets/nexlab-visual-v26-7.css?v=brand-r38",
  "./assets/nexlab-visual-v26-7.js?v=app-r2675-sidebar1",
