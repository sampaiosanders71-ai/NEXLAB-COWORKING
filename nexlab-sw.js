...
const CACHE_NAME='nexlab-v26-30-42-shell-r55630';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26342-meeting-response-automation-r55630',
  './assets/index-R55v26342.js?v=app-r26342-meeting-response-automation-r55630',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26342-meeting-response-automation-r55630',
  './assets/nexlab-update-manager.js?v=app-r26342-meeting-response-automation-r55630',
  './assets/nexlab-realtime-hub-r55630.js?v=app-r26342-meeting-response-automation-r55630',
  './assets/nexlab-visual.css?v=app-r26342-meeting-response-automation-r55630',
  './assets/nexlab-visual.js?v=app-r26342-meeting-response-automation-r55630',
  './assets/nexlab-vapid-rotation.js?v=app-r26342-meeting-response-automation-r55630',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R55v26342.js?v=app-r26342-meeting-response-automation-r55630',self.registration.scope).href,
