...
const CACHE_NAME='nexlab-v26-30-21-shell-r5568';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26321-agenda-privacy-bookings-r5568',
  './assets/index-R55v26321.js?v=app-r26321-agenda-privacy-bookings-r5568',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26321-agenda-privacy-bookings-r5568',
  './assets/nexlab-update-manager.js?v=app-r26321-agenda-privacy-bookings-r5568',
  './assets/nexlab-realtime-hub-r5568.js?v=app-r26321-agenda-privacy-bookings-r5568',
  './assets/nexlab-visual.css?v=app-r26321-agenda-privacy-bookings-r5568',
  './assets/nexlab-visual.js?v=app-r26321-agenda-privacy-bookings-r5568',
  './assets/nexlab-vapid-rotation.js?v=app-r26321-agenda-privacy-bookings-r5568',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R55v26321.js?v=app-r26321-agenda-privacy-bookings-r5568',self.registration.scope).href,
